 ...
 *
 * @param       useGlobal - If TRUE, then use default TC link key, if FALSE use 
 *                          pBuf as source for IC key derived input
 * @param       pBuf - The expected format and length of the IC is defined by 
 *                     BDB_INSTALL_CODE_USE
 *
