...
// 抽像继电器底层
#define MTURN_COILS1_ON()       HAL_TURN_ON_COIL1()
#define MTURN_COILS1_OFF()      HAL_TURN_OFF_COIL1()
#define MTURN_COILS2_ON()       HAL_TURN_ON_COIL2()
#define MTURN_COILS2_OFF()      HAL_TURN_OFF_COIL2()
#define MTURN_COILS3_ON()       HAL_TURN_ON_COIL3()
#define MTURN_COILS3_OFF()      HAL_TURN_OFF_COIL3()
